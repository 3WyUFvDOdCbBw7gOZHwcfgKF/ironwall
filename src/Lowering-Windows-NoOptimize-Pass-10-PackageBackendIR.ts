// No-opt lowering pass 10 Windows backend IR packaging and backend dispatch.
import type {
...
export function performNoOptimizeCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): PreparedLoweringStageCResult {
    return prepareNoOptimizeLoweringStageCFromArtifacts(programAst, options);
}

export function performNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResult {
...
export function performNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResult {
    const prepared = prepareNoOptimizeLoweringStageCFromArtifacts(programAst, options);
