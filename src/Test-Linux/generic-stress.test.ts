...
const fixtureDir: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "generic-stress");
const abortInputPath: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "generic-stress-typecheck", "test~generic~stress~array_wrapper_abort@main.iw");
