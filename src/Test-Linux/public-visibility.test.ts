...
const fixtureDir: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "public-visibility");
const abortFixtureDir: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "public-visibility-typecheck");
