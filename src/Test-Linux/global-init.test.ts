...
const fixtureDir: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "global-init");
const abortFixtureDir: string = join(repoRoot, "src", "Test-Linux", "Fixtures", "global-init-typecheck");
