...
const fixtureDir = join(repoRoot, "src", "Test-Linux", "Fixtures", "array-new-class");
const abortFixturePath = join(repoRoot, "src", "Test-Linux", "Fixtures", "array-new-class-abort", "test~array~new~class~abort_param_ctor@main.iw");
