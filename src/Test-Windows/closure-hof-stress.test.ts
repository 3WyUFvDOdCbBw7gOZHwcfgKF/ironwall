...
import { assertExpectedExitCode, assertRunResult, execBuildJsonCliSync, normalizeOutputLines, spawnBuildJsonCliSync } from "./BuildJsonCliHarness";
...
const fixtureDir = join(repoRoot, "src", "Test-Windows", "Fixtures", "closure-hof-stress");
...
assertExpectedExitCode(gcResult.status, (131 + firstReclaimed + secondReclaimed) & 0xff, `gc closure lifecycle final result mismatch\n${gcOutput}`);
