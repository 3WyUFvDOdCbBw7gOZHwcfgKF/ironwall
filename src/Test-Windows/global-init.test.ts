...
const fixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "global-init");
const abortFixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "global-init-typecheck");
