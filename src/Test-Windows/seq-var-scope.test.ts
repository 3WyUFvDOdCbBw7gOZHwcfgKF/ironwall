...
const fixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "seq-var-scope");
const abortFixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "seq-var-scope-typecheck");
