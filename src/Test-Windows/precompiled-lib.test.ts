...
const fixtureRoot = join(repoRoot, "src", "Test-Windows", "Fixtures", "precompiled-lib");
...
try {
    ...
    try {
        ...
        ok(
            ...
            "packed library assembly artifacts should end with a trailing newline and avoid Linux GNU-stack directives"
        );
        ok(
