...
const fixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "language-rules");
const abortFixtureDir: string = join(repoRoot, "src", "Test-Windows", "Fixtures", "language-rules-typecheck");
