...
const fixtureDir = join(repoRoot, "src", "Test-Windows", "Fixtures", "std-array");
const abortInputPath = join(fixtureDir, "test~std~array~abort@main.iw");
const typecheckAbortInputPath = join(repoRoot, "src", "Test-Windows", "Fixtures", "std-array-typecheck", "test~std~array~class~abort_param_ctor@main.iw");
