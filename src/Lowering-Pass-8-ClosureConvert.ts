...
export function validateClosureConvertedProgram(program: ClosureConvertedProgram): void {
...
export function closureConvertPass(program: CapturedMutableCheckedProgram): ClosureConvertedProgram {
    ...
    validateClosureConvertedProgram(convertedProgram);
