...
import {
    performOptimizedCBackendLoweringStageCFromArtifacts as performWindowsOptimizedCBackendLoweringStageCFromArtifacts,
...
type PreparedLoweringStageCResultAnyTarget = PreparedLoweringStageCResult | ReturnType<typeof performWindowsOptimizedCBackendLoweringStageCFromArtifacts>;

type LoweringStageCResultAnyTarget = (PreparedStageCResult & X64PassBundle) | ReturnType<typeof performWindowsLoweringStageCFromArtifacts>;

type NoOptimizeBackendLoweringStageCResultAnyTarget = NoOptimizeBackendLoweringStageCResult | ReturnType<typeof performWindowsOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts>;
...
export function performOptimizedCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: LoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsOptimizedCBackendLoweringStageCFromArtifacts>;
export function performOptimizedCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions & { readonly target?: "linux-x64" }): PreparedLoweringStageCResult;
export function performOptimizedCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): PreparedLoweringStageCResultAnyTarget;
export function performOptimizedCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): PreparedLoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsOptimizedCBackendLoweringStageCFromArtifacts(programAst, options);
    }
    return performOptimizedFrontendLoweringStageCFromArtifacts(programAst, options);
}

export function performLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: LoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsLoweringStageCFromArtifacts>;
export function performLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions & { readonly target?: "linux-x64" }): PreparedStageCResult & X64PassBundle;
export function performLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): LoweringStageCResultAnyTarget;
export function performLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): LoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsLoweringStageCFromArtifacts(programAst, options);
    }
...
export function performOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: LoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts>;
export function performOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions & { readonly target?: "linux-x64" }): NoOptimizeBackendLoweringStageCResult;
export function performOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): NoOptimizeBackendLoweringStageCResultAnyTarget;
export function performOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: LoweringStageCOptions): NoOptimizeBackendLoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsOptimizedFrontendNoOptimizedBackendLoweringStageCFromArtifacts(programAst, options);
    }
    const prepared = performOptimizedFrontendLoweringStageCFromArtifacts(programAst, options);
