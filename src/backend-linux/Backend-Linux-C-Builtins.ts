import type { BackendValueRepresentation } from "./Backend-Linux-IR-Shared";
...
export interface LinuxCBuiltinArtifacts {
...
export interface LinuxCBuiltinArtifactDependencies {
...
export function buildLinuxCBuiltinArtifacts(deps: LinuxCBuiltinArtifactDependencies): LinuxCBuiltinArtifacts {
    ...
    return {
        ...
        builtinHelpers,
        builtinRuntimeTypes,
        builtinSharedSyscallHelpers: loadLinuxCRuntimeTemplate("iw-syscall-linux.c"),
        builtinSharedThreadHelpers: loadLinuxCRuntimeTemplate("iw-thread-linux.c")
    };
}
