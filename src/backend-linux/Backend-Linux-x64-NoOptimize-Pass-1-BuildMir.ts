// Minimal no-opt x64 backend pass 1: build MIR.
import type {
...
import { x64NativeBoxedNumberValueSymbol, x64NativeDirectFunctionValueSymbol } from "./Backend-Linux-X64-NativeSupport";
