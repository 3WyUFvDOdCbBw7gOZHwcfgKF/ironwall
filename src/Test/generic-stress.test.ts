...
const fixtureDir: string = join(repoRoot, "src", "Test", "Fixtures", "generic-stress");
const abortInputPath: string = join(repoRoot, "src", "Test", "Fixtures", "generic-stress-typecheck", "test~generic~stress~array_wrapper_abort@main.iw");
