...
const fixtureDir: string = join(repoRoot, "src", "Test", "Fixtures", "language-rules");
const checkFixtureDir: string = join(repoRoot, "src", "Test", "Fixtures", "language-rules-check");
const abortFixtureDir: string = join(repoRoot, "src", "Test", "Fixtures", "language-rules-typecheck");
