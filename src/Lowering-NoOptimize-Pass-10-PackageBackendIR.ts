// No-opt lowering pass 10 backend IR packaging and backend dispatch.
import type {
...
import { analyzeNoOptimizeFreeVariablesPass, performNoOptimizeLoweringStageBFromArtifacts } from "./Lowering-NoOptimize-Pass-6-FreeVars";
import type { NoOptimizeLoweringStageBResult } from "./Lowering-Frontend-NoOptimize-Program";
import type { NoOptimizeLoweringSnapshotOptions } from "./Lowering-NoOptimize-Pass-0-Snapshot";
import { noOptimizeBoxCapturedMutablesPass } from "./Lowering-NoOptimize-Pass-7-BoxCapturedMutables";
import { noOptimizeClosureConvertPass } from "./Lowering-NoOptimize-Pass-8-ClosureConvert";
import { lowerTypedSlotsPass } from "./Lowering-NoOptimize-Pass-8a-LowerTypedSlots";
import { noOptimizeLinearizePass } from "./Lowering-NoOptimize-Pass-9-Linearize";
import { lowerToCfgPass } from "./Lowering-NoOptimize-Pass-9c-LowerToCfg";
import { buildSsaPass } from "./Lowering-NoOptimize-Pass-9f-BuildSSA";
import { canonicalizeSsaPass, validateSsaProgram } from "./Lowering-NoOptimize-Pass-9h-CanonicalizeSSA";
import { selectRepresentationsPass } from "./Lowering-NoOptimize-Pass-9b-SelectRepresentations";
import { annotateMayCollectPass } from "./Lowering-NoOptimize-Pass-9d-AnnotateMayCollect";
import { trimRootCandidatesPass } from "./Lowering-NoOptimize-Pass-9e-TrimRootCandidates";
import { trimCfgRootCandidatesPass } from "./Lowering-NoOptimize-Pass-9g-TrimCfgRoots";
import { planGcRootsFromCfgPass } from "./Lowering-NoOptimize-Pass-9a-PlanRoots";
import { buildX64MirPass } from "./backend-linux/Backend-Linux-x64-Pass-11x64-BuildMir";
import { selectX64InstructionsPass } from "./backend-linux/Backend-Linux-x64-Pass-12x64-SelectInstr";
import { copyPropagateX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-13x64-CopyPropagate";
import { livenessAnalysisX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-14a-x64-LivenessAnalysis";
import { buildInterferenceGraphX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-14b-x64-BuildInterferenceGraph";
import { graphColorRegallocX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-14c-x64-GraphColorRegalloc";
import { materializeRegallocX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-14d-x64-MaterializeRegalloc";
import { frameLayoutX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-15x64-FrameLayout";
import { postRaPeepholeX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-16x64-PostRAPeephole";
import { emitX64TextualAssemblyPass } from "./backend-linux/Backend-Linux-x64-Pass-16x64-Emit";
import { branchOptimizeX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-17x64-BranchOptimize";
import { layoutX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-18x64-Layout";
import { basicScheduleX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-18a-x64-BasicSchedule";
import { round2BranchOptimizeX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-19x64-Round2-BranchOptimize";
import { round2LayoutX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-20x64-Round2-Layout";
import { round2PeepholeX64Pass } from "./backend-linux/Backend-Linux-x64-Pass-21x64-Round2-Peephole";
import { buildX64MirPass as buildNoOptimizeX64MirPass } from "./backend-linux/Backend-Linux-x64-NoOptimize-Pass-1-BuildMir";
...
import { linearScanRegallocX64Pass as linearScanNoOptimizeX64Pass } from "./backend-linux/Backend-Linux-x64-NoOptimize-Pass-3-LinearScanRegalloc";
import { frameLayoutX64Pass as frameLayoutNoOptimizeX64Pass } from "./backend-linux/Backend-Linux-x64-NoOptimize-Pass-4-FrameLayout";
import { layoutX64Pass as layoutNoOptimizeX64Pass } from "./backend-linux/Backend-Linux-x64-NoOptimize-Pass-5-Layout";
import { emitX64TextualAssemblyPass as emitNoOptimizeX64TextualAssemblyPass } from "./backend-linux/Backend-Linux-x64-NoOptimize-Pass-6-Emit";
import { isWindowsTarget, type BuildTarget } from "./Target";
import {
    performNoOptimizeCBackendLoweringStageCFromArtifacts as performWindowsNoOptimizeCBackendLoweringStageCFromArtifacts,
...
interface NoOptimizeLoweringStageCOptions extends NoOptimizeLoweringSnapshotOptions {
    readonly target?: BuildTarget;
    readonly backendProfile?: "c-backend" | "optimized-x64-backend" | "no-optimized-backend";
}
...
export interface PreparedLoweringStageCResult extends NoOptimizeLoweringStageBResult {
    readonly pass7: NoOptimizeLoweringFrontendStageCResult["pass7"];
    readonly pass8: NoOptimizeLoweringFrontendStageCResult["pass8"];
    readonly pass8a: NoOptimizeLoweringFrontendStageCResult["pass8a"];
    readonly pass9: NoOptimizeLoweringFrontendStageCResult["pass9"];
    readonly pass9c: NoOptimizeLoweringFrontendStageCResult["pass9c"];
    readonly pass9f: NoOptimizeLoweringFrontendStageCResult["pass9f"];
    readonly pass9h: NoOptimizeLoweringFrontendStageCResult["pass9h"];
    readonly pass9b: NoOptimizeLoweringFrontendStageCResult["pass9b"];
    readonly pass9d: NoOptimizeLoweringFrontendStageCResult["pass9d"];
    readonly pass9e: NoOptimizeLoweringFrontendStageCResult["pass9e"];
    readonly pass9g: NoOptimizeLoweringFrontendStageCResult["pass9g"];
    readonly pass9a: NoOptimizeLoweringFrontendStageCResult["pass9a"];
    readonly pass10Support: NoOptimizeLoweringFrontendStageCResult["pass10"];
    readonly pass10: NoOptimizeLoweringFrontendStageCResult["pass10"];
}

export interface NoOptimizeLoweringStageCResult extends PreparedLoweringStageCResult, NoOptimizeX64PassBundle {}

type PreparedNoOptimizeLoweringStageCResultAnyTarget = PreparedLoweringStageCResult | ReturnType<typeof performWindowsNoOptimizeCBackendLoweringStageCFromArtifacts>;

type NoOptimizeLoweringStageCResultAnyTarget = NoOptimizeLoweringStageCResult | ReturnType<typeof performWindowsNoOptimizeLoweringStageCFromArtifacts> | ReturnType<typeof performWindowsNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts>;

function prepareNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): PreparedLoweringStageCResult {
    const artifacts = getMonomorphizedArtifacts();
    const stageB = performNoOptimizeLoweringStageBFromArtifacts(programAst, artifacts, options);
    const pass6 = analyzeNoOptimizeFreeVariablesPass(stageB.pass5);
    const pass7 = noOptimizeBoxCapturedMutablesPass(stageB.pass5, pass6);
    const pass8 = noOptimizeClosureConvertPass(pass7);
    const pass8a = lowerTypedSlotsPass(pass8);
    const pass9 = noOptimizeLinearizePass(pass8a);
...
function performOptimizedX64BackendLoweringStageC(prepared: PreparedLoweringStageCResult): OptimizedX64PassBundle {
...
function performNoOptimizedX64BackendLoweringStageC(prepared: PreparedLoweringStageCResult): NoOptimizeLoweringStageCResult {
...
function mergePreparedAndX64Lowering(prepared: PreparedLoweringStageCResult, x64: OptimizedX64PassBundle): NoOptimizeLoweringStageCResult {
    return {
        ...prepared,
        ...x64
    };
...
export function performNoOptimizeCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: NoOptimizeLoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsNoOptimizeCBackendLoweringStageCFromArtifacts>;
export function performNoOptimizeCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions & { readonly target?: "linux-x64" }): PreparedLoweringStageCResult;
export function performNoOptimizeCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): PreparedNoOptimizeLoweringStageCResultAnyTarget;
export function performNoOptimizeCBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): PreparedNoOptimizeLoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsNoOptimizeCBackendLoweringStageCFromArtifacts(programAst, options);
    }
    return prepareNoOptimizeLoweringStageCFromArtifacts(programAst, options);
}

export function performNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: NoOptimizeLoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsNoOptimizeLoweringStageCFromArtifacts>;
export function performNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions & { readonly target?: "linux-x64" }): NoOptimizeLoweringStageCResult;
export function performNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResultAnyTarget;
export function performNoOptimizeLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsNoOptimizeLoweringStageCFromArtifacts(programAst, options);
    }
    const prepared = prepareNoOptimizeLoweringStageCFromArtifacts(programAst, options);
    return mergePreparedAndX64Lowering(prepared, performOptimizedX64BackendLoweringStageC(prepared));
}

export function performNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options: NoOptimizeLoweringStageCOptions & { readonly target: "windows-x64" }): ReturnType<typeof performWindowsNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts>;
export function performNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions & { readonly target?: "linux-x64" }): NoOptimizeLoweringStageCResult;
export function performNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResultAnyTarget;
export function performNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst: import("./AstNode").AstNode, options?: NoOptimizeLoweringStageCOptions): NoOptimizeLoweringStageCResultAnyTarget {
    if (options?.target !== undefined && isWindowsTarget(options.target)) {
        return performWindowsNoOptimizeNoOptimizedBackendLoweringStageCFromArtifacts(programAst, options);
    }
    const prepared = prepareNoOptimizeLoweringStageCFromArtifacts(programAst, options);
